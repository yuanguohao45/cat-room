...
(function(window) {
    /**
      ...
      // 为编辑器实例添加一个路径，这个不能被注释
        ...
        serverUrl: 'https://interface.ccmapp.cn/fileController/uploadsimple',
        imageActionName: 'uploadimage',
        scrawlActionName: 'uploadscrawl',
        videoActionName: 'uploadvideo',
        fileActionName: 'uploadfile',
        imageUrlPrefix: 'https://interface.ccmapp.cn/fileController/uploadsimple',
        scrawlUrlPrefix: '',
        videoUrlPrefix: '',
        fileUrlPrefix: '',
        catcherLocalDomain: '',
        ...
        // imagePopup: true, // 图片操作的浮层开关，默认打开为true 现在关闭了
        ...
        outputXssFilter: false, // xss过滤白名单 名单来源: https://raw.githubusercontent.com/leizongmin/js-xss/master/lib/default.js
        ...
        whitList: {
          ...
          pre: ['class', 'style'],
          s: [],
          section: ['class', 'data-tools', 'style'],
          small: [],
          span: ['class', 'style'],
          sub: ['class', 'style'],
          sup: ['class', 'style'],
